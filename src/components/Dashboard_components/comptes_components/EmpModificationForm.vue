	...
	<div>
			...
			<form class="ui inverted form">
				...
				<div class="three fields">
					...
					<div class="field">
						...
						<input type="text" v-model="modForm.nomEntreprise" placeholder="Entreprise...">
					</div>
				</div>
					...
					<div class="ui info icon message" v-if="!allowMod">
						...
						<div class="content">
							...
							<div class="ui bulleted list">
								...
								<div class="item">Longeur minimum du <b>Nom d'entreprise</b> : 5 cractères </div>
		...
		<div class="ui modal" :id="[this.user._id]+'MOD'">
			...
			<div class="centered content">
				<p class="center aligned">Suohaitez-vous enregistrer les modifications apportées à cet employeur
	...
	export default {
		...
		methods: {
			...
			resetForm() {
				...
				this.modForm.nomEntreprise = this.user.nomEntreprise;
		...
		computed: {
			allowMod: function () {
				if (this.modForm.nom === this.user.nom && this.modForm.pnom === this.user.pnom && this.modForm.nomEntreprise ===
					this.user.nomEntreprise && this.modForm.dateNaiss ===
					...
					this.modForm.nomEntreprise.length < 5 || this.modForm.dateNaiss.length <= 0) {
					return false
				} else {
					return true
				}
